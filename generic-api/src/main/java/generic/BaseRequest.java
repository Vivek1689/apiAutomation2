...
//    }
    ...
    public String toString(){
        ...
        s.append("QuerPatams = ").append(this.queryParams.toString()).append("\n" );
        s.append("Path Params = ").append(this.pathParams.toString()).append("\n");
        s.append("Form Params = ").append(this.formParams.toString()).append("\n");
