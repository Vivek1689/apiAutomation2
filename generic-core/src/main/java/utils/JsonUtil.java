...
//                Logger.fail("getGenericDataForString - jsonString is empty/null !");
//            }
//            return type.cast(mapper.readValue(jsonString, type));
//        } catch (JsonProcessingException e) {
//            // TODO Auto-generated catch block
//            e.printStackTrace();
//            Logger.fail("getGenericDataForString - Unable to read value !");
//        }
//        return null;
//    }
//
...
//        else
//            Logger.fail("Data to insert is null !");
...
//        } else
//            Logger.fail("File path is not correct !");
//    }
//
...
//        } catch (Exception ex) {
//            ex.printStackTrace();
//            Logger.fail("Failed to parse the json file !");
//        }
//        return null;
//    }
//
...
//            Logger.fail("objectToReplace, key, existingValue, replaceValue can't be null. key can be empty !");
